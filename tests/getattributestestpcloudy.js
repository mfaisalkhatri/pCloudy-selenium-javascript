...
let pcloudyCapabilities = require("../capabilities.js");

describe("get attributes test on pcloudy", () => {
  let driver;
  const gridUrl =
    "https://prod-browsercloud-in.pcloudy.com/seleniumcloud/wd/hub";

  before(async () => {
    driver = await new webdriver.Builder()
      .usingServer(gridUrl)
      .withCapabilities(pcloudyCapabilities.capabilities)
      .build();
  });
